...
#define REPORTID_HAPTIC_INTENSITY 0x0a
#define REPORTID_HAPTIC_WAVEFORMS 0x0b
#define REPORTID_HAPTIC_TRIGGER   0x0c
#define REPORTID_HAPTICS          REPORTID_HAPTIC_TRIGGER
